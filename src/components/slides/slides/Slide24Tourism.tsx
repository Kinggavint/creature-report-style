...
import exhibitImg from "@/assets/exhibit-7.png";

const Slide24Tourism = () => (
  <SlideLayout>
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-20">
      <p className="text-[22px] font-medium tracking-[0.3em] uppercase mb-6" style={{ color: "#D4A853" }}>Partnerships</p>
      ...
      <p className="text-[24px]" style={{ color: "rgba(255,255,255,0.5)" }}>
        Visit Seattle · King County Metro Bus Advertising
      </p>
    </div>
  </SlideLayout>
);

export default Slide24Tourism;
