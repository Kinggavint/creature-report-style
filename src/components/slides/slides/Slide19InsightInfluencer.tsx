...
import exhibitImg from "@/assets/exhibit-5.png";

const Slide19InsightInfluencer = () => (
  <SlideLayout>
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-20">
      <p className="text-[22px] font-medium tracking-[0.3em] uppercase mb-6" style={{ color: "#D4A853" }}>Key Insight 3</p>
      <h2 className="text-[64px] font-bold leading-tight mb-8" style={{ fontFamily: "'Playfair Display', serif", color: "#FAFAF0" }}>
        Influencer & Cross-Platform Outreach<br />Expanded Reach
      </h2>
      ...
      <p className="text-[24px]" style={{ color: "rgba(255,255,255,0.5)" }}>
        RedNote · JoinBrands · Afluencer · Direct Outreach
      </p>
    </div>
  </SlideLayout>
);

export default Slide19InsightInfluencer;
