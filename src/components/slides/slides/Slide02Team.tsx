...
import christyImg from "@/assets/slides/christy-shen.png";
import juliaImg from "@/assets/slides/julia-powell.png";
...
const team = [
  ...
  { name: "Gavin Turnmire", role: "Digital Infrastructure", img: gavinImg, pos: "center 20%", desc: "Responsible for Google Ads, GA4 + Tag Manager, SEO, Google Business Profile, and AI tooling." },
          ...
          <div key={m.name} className="flex flex-col items-center text-center flex-1 max-w-[340px]">
            ...
            <div className="w-[240px] h-[280px] rounded-2xl overflow-hidden mb-5 flex-shrink-0 border-[3px]" style={{ borderColor: "#00A896" }}>
              {m.img ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-[56px] font-bold" style={{ background: "linear-gradient(135deg, rgba(0,168,150,0.2), rgba(212,168,83,0.15))", color: "#00A896" }}>
