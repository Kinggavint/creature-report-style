...
const Slide28Conclusion = () => (
  <SlideLayout>
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-24">
      <h2 className="text-[56px] font-bold mb-8" style={{ fontFamily: "'Playfair Display', serif", color: "#00A896" }}>
        Conclusion
      </h2>
      <div className="w-28 h-1 rounded-full mb-10" style={{ background: "linear-gradient(90deg, #00A896, #D4A853)" }} />
      <div className="rounded-xl p-10 mb-8 w-full max-w-[1200px]" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)" }}>
        <p className="text-[24px] font-medium mb-4" style={{ color: "#D4A853" }}>Our Question:</p>
        <p className="text-[28px] italic leading-relaxed" style={{ color: "rgba(255,255,255,0.8)" }}>
          Can we use social media, Google Ads, marketing, and influencers to increase ticket sales and awareness?
        </p>
      </div>
      <div className="rounded-xl p-10 w-full max-w-[1200px]" style={{ background: "rgba(0,168,150,0.04)", border: "1px solid rgba(0,168,150,0.15)" }}>
        <p className="text-[24px] font-medium mb-4" style={{ color: "#00A896" }}>Answer:</p>
        <p className="text-[24px] leading-relaxed" style={{ color: "rgba(255,255,255,0.8)" }}>
