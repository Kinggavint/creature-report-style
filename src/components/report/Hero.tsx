  ...
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center max-w-4xl mx-auto px-6 py-20">
      <p className="text-primary font-sans text-sm tracking-[0.3em] uppercase mb-6">
        Orlando Community Impact • Spring 2026
      </p>
      ...
      <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
        A comprehensive analysis of digital strategy, community engagement, and tourism impact
        for the Exquisite Creatures exhibit at the Orlando Science Center.
      </p>
    </div>
